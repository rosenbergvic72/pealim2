...
const StatModal4Es = ({ visible, onToggle }) => {
  ...
  //       const exerciseId = 'exercise4'; // Ensure you use the correct exercise ID
  ...
  useEffect(() => {
    if (visible) {
      const fetchStats = async () => {
        const stats = await getStatistics('exercise4Es');
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView} ref={viewRef}>
          ...
          <Animated.View style={{ opacity: animationFinished ? contentOpacity : 0 }}>
            ...
            <Text style={styles.modalText}maxFontSizeMultiplier={1.2}>ESTADÍSTICAS DEL EJERCICIO 7</Text>
            {stats ? (
