...
},[fullCardEnabled,fullCardAnim]);

const fullCardBackgroundColor=fullCardAnim.interpolate({
inputRange:[0,1],
outputRange:['#D9D9D9','#83A3CD']
});

const fullCardTextColor=fullCardAnim.interpolate({
inputRange:[0,1],
outputRange:['#8D8D8D','#FFFDEF']
});

const fullCardScale=fullCardAnim.interpolate({
inputRange:[0,0.65,1],
...
<TypewriterTextLTR
text={verbData.verbPortuguese}
typingSpeed={40}
style={styles.verbPortuguese}
