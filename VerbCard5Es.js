...
const VerbCard5Es = ({ verbData, onAnswer }) => {
...
<View style={styles.lowerContainer}>
    ...
    <View style={styles.upperContainer}>
      <View style={styles.leftContainer}>
        <TypewriterTextLTR text={verbData.ImperEs} typingSpeed={40} style={styles.impertext}maxFontSizeMultiplier={1.2}/>
