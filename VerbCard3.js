...
const VerbCard3 = ({ verbData, onAnswer, soundEnabled, highlightEnabled = true }) => {
  ...
  return (
    <View style={styles.cardContainer}>
      <View style={styles.hebrewVerbContainer}>
        ...
        {/* ✅ Корень: зелёная метка + чёрное значение (и подсветка в корне как EN) */}
...
const styles = StyleSheet.create({
  ...
  // ✅ чтобы не прыгало по высоте, как в EN
  hebrewVerbWrapper: {
    width: '100%',
    height: 50,
 ...
 hebrewVerb: {
  ...
  color: '#333652',
  textAlign: 'center',
  // includeFontPadding: false, // лучше только для Android
},

  // ✅ стиль подсветки (в EN он назван prefixYellow, но цвет синий)
