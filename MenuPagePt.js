...
import AppDescriptionModal from './AppDescriptionModalPt'; // Подключаем модальное окно
import AppInfoModal from './AppInfoModalPt'; // Подключаем модальное окно
...
export default function MenuPage({ route }) {
  ...
  const button9Opacity = useRef(new Animated.Value(0)).current;
    ...
    const fetchStatistics = async () => {
      const exerciseIds = ['exercise1Pt', 'exercise2Pt', 'exercise3Pt', 'exercise5Pt', 'exercise6Pt', 'exercise8Pt', 'exercise4Pt', 'exercise7Pt'];
      const statsData = {};
      ...
      <Image source={require('./STAT2.png')} style={styles.statsImage} />
                <View style={styles.statsTextContainer}>
                  <View style={styles.statsRow}>
                    <Text style={styles.statsText} maxFontSizeMultiplier={1.2}>EXERCÍCIOS CONCLUÍDOS</Text>
                    <View style={styles.statsBox} >
                      <Text style={styles.statsValue} maxFontSizeMultiplier={1.2}>{totalExercisesCompleted}</Text>
                    </View>
                  </View>
                  <View style={styles.statsRow}>
                    <Text style={styles.statsText} maxFontSizeMultiplier={1.2}>RESULTADO MÉDIO</Text>
                    <View style={styles.statsBox}>
                      <Text style={styles.statsValue} maxFontSizeMultiplier={1.2}>{averageCompletionRate}%</Text>
                    </View>
                  </View>
                  <View style={styles.statsRow}>
                    <Text style={styles.statsText} maxFontSizeMultiplier={1.2}>DIAS DE TREINO</Text>
                    <View style={styles.statsBox}>
...
<View style={styles.content}>
    ...
    <TouchableOpacity onPress={() => handlePress('Exercise1Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 1</Text>
        <Image source={require('./star1.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>CARTÕES DE VERBOS HEBRAICO-PORTUGUÊS</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise1Pt'] ? stats['exercise1Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise1Pt'] ? stats['exercise1Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  
  <Animated.View style={[styles.buttonContainer, { opacity: button2Opacity, transform: [{ translateY: button2TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise2Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 2</Text>
        <Image source={require('./star2.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>CARTÕES DE VERBOS PORTUGUÊS-HEBRAICO</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise2Pt'] ? stats['exercise2Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise2Pt'] ? stats['exercise2Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  
  <Animated.View style={[styles.buttonContainer, { opacity: button3Opacity, transform: [{ translateY: button3TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise3Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 3</Text>
        <Image source={require('./star3.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>IDENTIFICAR O BINYAN</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise3Pt'] ? stats['exercise3Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise3Pt'] ? stats['exercise3Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  
  <Animated.View style={[styles.buttonContainer, { opacity: button6Opacity, transform: [{ translateY: button6TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise5Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 4</Text>
        <Image source={require('./star3.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>MODO IMPERATIVO</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise5Pt'] ? stats['exercise5Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise5Pt'] ? stats['exercise5Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  ...
  <Animated.View style={[styles.buttonContainer, highlightedButtonStyle, { opacity: button5Opacity, transform: [{ translateY: button5TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise6Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 5</Text>
        <Image source={require('./star4.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>CONJUGAÇÃO DE VERBOS PORTUGUÊS-HEBRAICO</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise6Pt'] ? stats['exercise6Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise6Pt'] ? stats['exercise6Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  ...
  <Animated.View style={[styles.buttonContainer, highlightedButtonStyle, { opacity: button8Opacity, transform: [{ translateY: button8TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise8Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 6</Text>
        <Image source={require('./star4.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>CONJUGAÇÃO DE VERBOS HEBRAICO-PORTUGUÊS</Text>
      </View>
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise8Pt'] ? stats['exercise8Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise8Pt'] ? stats['exercise8Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  
  <Animated.View style={[styles.buttonContainer, { opacity: button4Opacity, transform: [{ translateY: button4TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise4Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCÍCIO 7</Text>
      ...
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise4Pt'] ? stats['exercise4Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise4Pt'] ? stats['exercise4Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  
  <Animated.View style={[styles.buttonContainer, { opacity: button7Opacity, transform: [{ translateY: button7TranslateY }] }]}>
    <TouchableOpacity onPress={() => handlePress('Exercise7Pt')}>
      <View style={styles.upperPart1}>
        <Text style={styles.upperText1} maxFontSizeMultiplier={1.1}>EXERCÍCIO 8</Text>
        <Image source={require('./star5.png')} style={[styles.image1]} />
      </View>
      <View style={styles.upperPart2}>
        <Text style={styles.upperText} maxFontSizeMultiplier={1.1}>CONJUGAÇÃO DE VERBOS HEBRAICO-PORTUGUÊS</Text>
      ...
      <View style={styles.lowerRight}>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETADO <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise7Pt'] ? stats['exercise7Pt'].timesCompleted : 0}</Text> </Text>
        <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>PONTUAÇÃO MÉDIA <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise7Pt'] ? stats['exercise7Pt'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
  ...
  <Text style={styles.titleText1} maxFontSizeMultiplier={1.2}>DESCRIÇÃO DO APLICATIVO</Text>
</TouchableOpacity>
</Animated.View>
...
<TouchableOpacity style={styles.button} onPress={() => setIsInfoModalVisible(true)}>
  <Text style={styles.titleText1} maxFontSizeMultiplier={1.2}>SOBRE O APLICATIVO</Text>
</TouchableOpacity>
