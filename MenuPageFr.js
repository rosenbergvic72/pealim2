...
export default function MenuPage({ route }) {
  ...
  const fetchStatistics = async () => {
    const exerciseIds = ['exercise1Fr', 'exercise2Fr', 'exercise3Fr', 'exercise5Fr', 'exercise6', 'exercise8', 'exercise4', 'exercise7'];
    const stats = {};
      ...
      <View style={styles.content}>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button5Opacity, transform: [{ translateY: button5TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise6')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLÉTÉ  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise6'] ? stats['exercise6'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>SCORE MOYEN  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise6'] ? stats['exercise6'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button8Opacity, transform: [{ translateY: button8TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise8')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLÉTÉ  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise8'] ? stats['exercise8'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>SCORE MOYEN  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise8'] ? stats['exercise8'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button4Opacity, transform: [{ translateY: button4TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise4')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLÉTÉ  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise4'] ? stats['exercise4'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>SCORE MOYEN  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise4'] ? stats['exercise4'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button7Opacity, transform: [{ translateY: button7TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise7')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLÉTÉ  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7'] ? stats['exercise7'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>SCORE MOYEN  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7'] ? stats['exercise7'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <TouchableOpacity style={localstyle.button} onPress={() => handlePress('Exercise1')}>
          <View>
            <Text style={localstyle.text}>NIKUD EN HÉBREU</Text>
          </View>
        </TouchableOpacity>

        <TouchableOpacity style={localstyle.button} onPress={() => handlePress('Exercise1')}>
          <View>
            <Text style={localstyle.text}>BINYANIM EN HÉBREU</Text>
          </View>
        </TouchableOpacity>
      </View>
    </ScrollView>
