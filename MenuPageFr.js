...
export default function MenuPage({
  ...
  const handleReportBug = useCallback(async () => {
    ...
    const subject = encodeURIComponent(
      'Signaler une erreur dans la base Verbify'
    );
  ...
  >
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('VerbLibrary', { language: 'fr' })}
    >
      <View style={styles.verbLibraryTextContainer}>
        ...
        <Text
          ...
          maxFontSizeMultiplier={1.2}
        >
          RÉFÉRENCE POUR TOUTE LA BASE VERBIFY
        </Text>
      </View>
    </TouchableOpacity>
  </Animated.View>
    ...
    CHOISISSEZ UN EXERCICE
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise3Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise3Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise5Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise5Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise6Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise6Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise8Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise8Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
            ...
            >
              ...
              <View style={styles.upperPart2}>
                <Text
                  ...
                  maxFontSizeMultiplier={1.2}
                >
                  PRÉPOSITIONS APRÈS LES VERBES ET PRÉPOSITIONS-PRÉFIXES
                </Text>
              </View>
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise4Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise4Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
          ...
          <Animated.View
            style={[
              ...
              isLocked('Exercise7Fr') &&
                lockStyle,
            ]}
          >
            <TouchableOpacity
              onPress={() =>
                handlePress('Exercise7Fr')
              }
            >
              <View style={styles.upperPart1}>
                <Text
