...
const translations = {
  ...
  es: {
    ...
    intro3:
      'Este ejercicio se recomienda a quienes ya estudian hebreo y tienen al menos conocimientos básicos sobre conjugaciones. Incluso con una comprensión mínima, la práctica regular ayuda a memorizar las formas, identificar patrones y reforzarlos. Fomenta una comprensión profunda del sistema verbal, desarrolla la intuición gramatical y mejora la comprensión del hebreo.',
    section: 'Botones',
  ...
  ar: {
    ...
    intro2:
      'في كل جولة، يتم اختيار فعل عبري عشوائيًا، ويجب عليك إيجاد المطابقة الصحيحة لإحدى صيغه. سيتم عرض 6 أزواج من أصل 36 (أو 24)، تحتوي على صيغ عبرية وخيارات مقابلة باللغة المحددة. مهمتك هي مطابقتها بشكل صحيح، أي اختيار العنصر في العمود الأيسر، ثم نظيره العبري في العمود الأيمن.',
    intro3:
      'يوصى بهذا التمرين لمن يدرسون اللغة العبرية ولديهم معرفة أساسية بتصريف الأفعال. حتى مع القليل من الفهم، فإن التمرين المنتظم سيساعدك على تذكر الصيغ، واكتشاف الأنماط، وتعزيزها. إنه يعزز الفهم العميق للتصريف، ويطور الإدراك الغريزي للقواعد، ويحسن فهم العبرية.',
    section: 'الأزرار',
  ...
  am: {
    ...
    intro2:
      'በእያንዳንዱ ዙር፣ አንድ የዕብራይስጥ ግስ የማይታወቀው በመምረጥ ይታያል፣ እና ከዚህ ጋር ከሰዋሰው ቅርጾቹ አንዱ ጋር መጣጣም የሚችል እኩል መፈለግ ይኖርብዎታል። ከ36 (ወይም 24) ውስጥ 6 ጥናቶች ይታያሉ፣ በእያንዳንዱ ጊዜ የዕብራይስጥ ቅርጾችና ትርጉሞቻቸው ይቀርባሉ።',
    intro3:
      'ይህ ልምድ ከዚህ በፊት ንዑስ የእውቀት ያላቸውን የዕብራይስጥ ተማሪዎች ይመረጣል። በትንሽ እውቀት ቢሆንም፣ በደንብ ማድረግ ሰዋሰው ቅርጾችን ማስታወስ፣ ደጋግመኛ አቀማመጦችን መረዳት እና እነሱን ማጠናከር ይቻላል።',
    section: 'አዝራሮች',
