...
FirebaseAnalytics.logFirebaseEvent('exercise4am',{
screen:'exercise4am'
});
...
const handleSpeakerPress = (mp3) => {
  ...
  const handleExerciseCompletion = async () => {
    if (!statisticsUpdated) {
      ...
      setTimeout(async () => {
        try {
          await updateStatistics('exercise5Am', currentScore);
