...
import TaskDescriptionModal8Fr from './TaskDescriptionModal8Fr';
  ...
  useEffect(() => {
    if (verbs.length > 0) {
      ...
      const incorrectAnswers = shuffleArray(
        sameInfinitiveVerbs.filter((verb) => verb.frtext !== currentVerb.frtext)
      ).slice(0, 5);
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity onPress={toggleDescriptionModal}>
            ...
            <TaskDescriptionModal8Fr visible={isDescriptionModalVisible} onToggle={toggleDescriptionModal} />
          </TouchableOpacity>
