  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.messageContainer}>
        <Text style={styles.completedMessage} maxFontSizeMultiplier={1.2}>ልምምዱ ተጠናቀቀ!</Text>
        ...
        <TouchableOpacity onPress={restartTask}>
          <Text style={styles.continueButton} maxFontSizeMultiplier={1.2}>ቀጥል</Text>
        </TouchableOpacity>
    
        <TouchableOpacity onPress={() => {
          handleOK();
          navigation.navigate('MenuAm'); // Направляем на экран MenuEn
        }}>
          <Text style={styles.completeButton} maxFontSizeMultiplier={1.2}>ምናሌ</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default CompletionMessageAm;
