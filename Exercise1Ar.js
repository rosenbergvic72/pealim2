...
FirebaseAnalytics.logFirebaseEvent('exercise1ar',{
screen:'exercise1ar'
});
...
.setValue(0);
  }, [loadLists, selectedExerciseCount]);
  ...
  onOpenFullCard={openFullVerbCard}
            ...
            {exerciseCompleted && (
              <CompletionMessageAr
                ...
                grade={getGrade((correctAnswers / (correctAnswers + incorrectAnswers || 1)) * 100)}
