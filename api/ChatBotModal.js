...
const ChatBotModal = ({ visible, onClose, blockModalCloseRef }) => {
  ...
  const translations = {
    ...
    አማርኛ: {
      placeholder: 'ስለ የእብራይስጥ ግስ ጠይቅ...',
      you: 'አንተ',
      loading: 'እባክህ ትንሽ ጠብቅ፣ ቦት እየመለሰ ነው...',
      greeting:
        'ሰላም! እብራይስጥን ለመረዳት እረዳሃለሁ — በተለይም ግሶችን እና የእነሱን ማስተላለፊያ 🔤',
      helpHint:
        'ለምሳሌ፦ ግስ “ללכת” እንዴት ይታይ? ወይም ከታች ፈጣን ጥያቄ ምረጥ።',
      saved: '✅ መልስ ተቀምጧል!',
  ...
  const conjugateCommand = {
    ...
    العربية: (verb) => `صَرِّف الفعل ${verb}`,
    አማርኛ: (verb) => `ግስ ${verb} አስተላልፍ`,
  };
