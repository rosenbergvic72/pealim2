        ...
        <View style={styles.modalView}>
          ...
          >
            ...
            {searchResults.map((result, index) => (
              ...
              >
                {/* верхний блок — инфинитив + фр. перевод + основная транслит */}
                <Text
                ...
                <Text
                  style={[styles.resultTextBase, styles.frenchShortText]}
                  maxFontSizeMultiplier={1.2}
                >
                  {result.french}
                </Text>
                ...
                <Text
                  style={[styles.resultTextBase, styles.frenchPhraseText]}
                  maxFontSizeMultiplier={1.2}
                >
                  {result.frtext}
                </Text>
