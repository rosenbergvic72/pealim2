        ...
        <View style={styles.modalView}>
          ...
          >
            ...
            {searchResults.map((result, index) => (
              ...
              >
                {/* верхний блок — инфинитив + короткий перевод + основная транслит */}
                <Text
                ...
                <Text
                  style={[styles.resultTextBase, styles.englishShortText]}
                  maxFontSizeMultiplier={1.2}
                >
                  {result.english}
                </Text>
                ...
                {/* нижний блок — 3 строки, выравнены вправо, другие цвета */}
                <Text
                ...
                <Text
                  style={[styles.resultTextBase, styles.englishPhraseText]}
                  maxFontSizeMultiplier={1.2}
                >
                  {result.entext}
                </Text>
