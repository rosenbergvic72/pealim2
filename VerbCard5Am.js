...
const VerbCard5Am = ({ verbData, onAnswer }) => {
...
<View style={styles.lowerContainer}>
    ...
    <View style={styles.upperContainer}>
      <View style={styles.leftContainer}>
        <TypewriterTextLTR text={verbData.ImperAm} typingSpeed={40} style={styles.impertext}maxFontSizeMultiplier={1.2}/>
