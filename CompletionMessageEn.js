  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.messageContainer}>
        <Text style={styles.completedMessage} maxFontSizeMultiplier={1.2}>Exercise completed!</Text>
        ...
        <TouchableOpacity onPress={restartTask}>
          <Text style={styles.continueButton} maxFontSizeMultiplier={1.2}>CONTINUE</Text>
        </TouchableOpacity>
    
        <TouchableOpacity onPress={() => {
          handleOK();
          navigation.navigate('MenuEn'); // Направляем на экран MenuEn
        }}>
...
export default CompletionMessageEn;
