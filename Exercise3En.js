...
<Animated.View style={[styles.percentContainer, { backgroundColor, borderRadius: 10 }]}>
    <Text style={styles.percentText}maxFontSizeMultiplier={1.2}>
      ...
      <Animated.Text style={[styles.title, { opacity: fadeAnim }]} maxFontSizeMultiplier={1.2}>SELECT BINYAN</Animated.Text>
  ...
  {optionsOrder.map((option, index) => (
    ...
    >
      ...
      <TouchableOpacity
        ...
        disabled={!showNextButton}
      >
        <Text style={styles.nextButtonText} maxFontSizeMultiplier={1.2}>NEXT VERB</Text>
      </TouchableOpacity>
