...
const translations = {
  ...
  en: {
    ...
    intro1:
      'This is an advanced exercise designed for those who have already mastered Exercises 5 and 6. It is similar to Exercise 6, but instead of one verb per round, you will conjugate randomly selected verbs from the entire database.',
    intro2:
      'In each round, verbs in one of the conjugated Hebrew forms will be randomly selected. Your task is to choose the correct translation in the selected language from 6 given options.',
    intro3:
      'This exercise is intended for advanced learners who are familiar with Hebrew verb conjugation. It helps develop automation, improve recognition speed, and deepen understanding of conjugation patterns across different binyanim. Regular practice reinforces mastery of verb conjugation, boosts confidence in using Hebrew verbs, and significantly enhances grammatical intuition.',
    section: 'Buttons',
  ...
  fr: {
    ...
    intro1:
      'C’est un exercice avancé destiné à ceux qui maîtrisent déjà les exercices 5 et 6. Il est similaire à l’exercice 6, mais ici, plusieurs verbes aléatoires sont utilisés à chaque tour.',
    intro2:
      'À chaque tour, des formes conjuguées en hébreu de différents verbes sont choisies au hasard. Votre tâche est de choisir la bonne traduction dans la langue sélectionnée parmi 6 options proposées.',
    intro3:
      'Cet exercice s’adresse aux apprenants avancés qui connaissent bien la conjugaison des verbes hébreux. Il aide à automatiser les réponses, à améliorer la vitesse de reconnaissance et à approfondir la compréhension des modèles de conjugaison. Une pratique régulière renforce la maîtrise, augmente la confiance et améliore fortement l’intuition grammaticale.',
    section: 'Boutons',
  ...
  es: {
    ...
    intro1:
      'Este es un ejercicio avanzado destinado a quienes ya dominan los ejercicios 5 y 6. Es similar al ejercicio 6, pero en lugar de un solo verbo, se utilizan varios verbos seleccionados aleatoriamente de toda la base de datos.',
    intro2:
      'En cada ronda se seleccionan aleatoriamente formas verbales en hebreo de diferentes verbos. Tu tarea es elegir la traducción correcta en el idioma seleccionado entre 6 opciones.',
    intro3:
      'Este ejercicio está dirigido a estudiantes avanzados familiarizados con la conjugación de verbos en hebreo. Ayuda a desarrollar automatismo, mejorar la velocidad de reconocimiento y profundizar en los patrones de conjugación. La práctica regular fortalece el dominio del sistema, aumenta la confianza y mejora significativamente la intuición gramatical.',
    section: 'Botones',
  ...
  pt: {
    ...
    intro1:
      'Este é um exercício avançado, destinado a quem já domina os exercícios 5 e 6. É semelhante ao exercício 6, mas agora são usados vários verbos aleatórios da base de dados em cada rodada.',
    intro2:
      'Em cada rodada, são selecionadas formas conjugadas em hebraico de verbos aleatórios. Sua tarefa é escolher a tradução correta no idioma selecionado entre 6 opções.',
    intro3:
      'Este exercício é indicado para estudantes avançados que já conhecem bem a conjugação dos verbos em hebraico. Ele ajuda a desenvolver automatismo, melhorar a velocidade de reconhecimento e aprofundar o entendimento dos padrões de conjugação. A prática constante fortalece o domínio do sistema verbal, aumenta a confiança e melhora significativamente a intuição gramatical.',
    section: 'Botões',
    sound: 'Botões de som',
  ...
  ar: {
    ...
    intro1:
      'هذا تمرين متقدم مخصص لأولئك الذين أتموا بنجاح التمرينين 5 و6. وهو مشابه للتمرين 6، ولكن يتم استخدام أفعال عشوائية متعددة من قاعدة البيانات في كل جولة.',
    intro2:
      'في كل جولة، يتم اختيار أفعال بصيغة معينة من صيغ التصريف العبري بشكل عشوائي. مهمتك هي اختيار الترجمة الصحيحة من بين 6 خيارات باللغة المحددة.',
    intro3:
      'هذا التمرين مخصص للمتعلمين المتقدمين الذين لديهم معرفة جيدة بتصريف الأفعال في اللغة العبرية. يساعد على تطوير التلقائية، وتحسين سرعة التعرف على الصيغ، وتعميق فهم أنماط التصريف. الممارسة المنتظمة تعزز الإتقان، وتزيد من الثقة، وتحسن الحدس النحوي بشكل كبير.',
    section: 'الأزرار',
  ...
  am: {
    ...
    intro1:
      'ይህ የላቀ ልምድ ሲሆን ለልምዶች 5 እና 6 በተሟላ መንገድ የተረዱ ተማሪዎች ነው። ከልምድ 6 ጋር ተመሳሳይ ነው፣ ነገር ግን በአንድ ዙር ላይ አንድ ግስ ሳይሆን ከመረጠ የግሶች መረጃ ቋት የተወሰኑ ግሶች ይታያሉ።',
    intro2:
      'በእያንዳንዱ ዙር አንድ የግስ ቅርጽ ያላቸው ግሶች በተደራሽ መንገድ ይመረጣሉ። የተሰጡት 6 አማራጮች ውስጥ እኩል የትክክለኛውን ትርጉም ይምረጡ።',
    intro3:
      'ይህ ልምድ በዕብራይስጥ ግሶች ሰዋሰው የበለጠ እውቀት ላላቸው ተማሪዎች ይመረጣል። በደንብ ማድረግ የሚረዳው አስተማማኝነትን፣ የማወቅ ፍጥነትንና በበለጠ ጥልቀት የሚታወቀውን ሥነ-ሰዋሰው ያደጋል።',
    section: 'አዝራሮች',
...
const TaskDescriptionModal8 = ({ visible, onToggle, language }) => {
