  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.messageContainer}>
        <Text style={styles.completedMessage} maxFontSizeMultiplier={1.2}>Exercice terminé!</Text>
        ...
        <TouchableOpacity onPress={restartTask}>
          <Text style={styles.continueButton} maxFontSizeMultiplier={1.2}>CONTINUER</Text>
        </TouchableOpacity>
...
export default CompletionMessageFr;
