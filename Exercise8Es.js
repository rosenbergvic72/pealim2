...
import TaskDescriptionModal8Es from './TaskDescriptionModal8Es';
  ...
  useEffect(() => {
    if (verbs.length > 0) {
      ...
      const incorrectAnswers = shuffleArray(
        sameInfinitiveVerbs.filter((verb) => verb.estext !== currentVerb.estext)
      ).slice(0, 5);
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity onPress={toggleDescriptionModal}>
            ...
            <TaskDescriptionModal8Es visible={isDescriptionModalVisible} onToggle={toggleDescriptionModal} />
          </TouchableOpacity>
