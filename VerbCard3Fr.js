...
const VerbCard3Fr = ({ verbData, onAnswer, soundEnabled, highlightEnabled = true }) => {
  ...
  return (
    <View style={styles.cardContainer}>
      <View style={styles.hebrewVerbContainer}>
        ...
        {/* ✅ корень: зелёная метка + чёрное значение (с подсветкой как EN/RU/ES) */}
