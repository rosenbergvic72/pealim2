...
const translations = {
  ...
  en: {
    ...
    intro1:
      'This is an advanced exercise intended for those who have successfully completed Exercises 5 and 6. It is similar to Exercise 5, but instead of conjugating one verb per round, you will conjugate randomly selected verbs from the entire database.',
    intro2:
      'In each round, 6 pairs of verb forms will be shown. Your task is to correctly match the Hebrew verb forms with their corresponding translations in the selected language. As in Exercise 5, you first select a variant in the left column, then its match on the right.',
    intro3:
      'This exercise is designed for advanced learners who are already familiar with Hebrew verb conjugation. It helps develop automation, improve recognition speed, and deepen understanding of conjugation patterns across different binyanim. Regular practice with this task strengthens mastery of the verb system, increases confidence in using Hebrew verbs, and greatly enhances grammatical intuition.',
    section: 'Buttons',
  ...
  fr: {
    ...
    intro1:
      'C’est un exercice avancé destiné à ceux qui réussissent déjà les exercices 5 et 6. Il est similaire à l’exercice 5, mais ici, plusieurs verbes aléatoires sont conjugués dans un même tour.',
    intro2:
      'À chaque tour, vous verrez 6 paires de formes verbales. Votre tâche est d’associer correctement les formes en hébreu avec leurs traductions dans la langue choisie. Comme dans l’exercice 5, vous sélectionnez d’abord une option dans la colonne de gauche, puis sa correspondance dans celle de droite.',
    intro3:
      'Cet exercice s’adresse aux apprenants avancés qui maîtrisent déjà la conjugaison des verbes hébreux. Il aide à automatiser les réponses, à améliorer la rapidité de reconnaissance et à approfondir la compréhension des modèles de conjugaison dans différents binyanim. Une pratique régulière renforce la maîtrise des conjugaisons, accroît la confiance en soi et améliore fortement l’intuition grammaticale.',
    section: 'Boutons',
  ...
  es: {
    ...
    intro1:
      'Este es un ejercicio avanzado destinado a quienes ya dominan los ejercicios 5 y 6. Es similar al ejercicio 5, pero en lugar de conjugar un solo verbo, se presentan varios verbos seleccionados aleatoriamente de toda la base de datos.',
    intro2:
      'En cada ronda se muestran 6 pares de formas verbales. Tu tarea es emparejar correctamente las formas en hebreo con sus traducciones en el idioma seleccionado. Como en el ejercicio 5, primero eliges una opción en la columna izquierda y luego su correspondencia en la derecha.',
    intro3:
      'Este ejercicio está diseñado para estudiantes avanzados que ya están familiarizados con la conjugación de verbos en hebreo. Ayuda a desarrollar automatización, mejorar la velocidad de reconocimiento y profundizar en los patrones de conjugación en los diferentes binyanim. La práctica constante fortalece el dominio del sistema verbal, aumenta la confianza en el uso del hebreo y mejora notablemente la intuición gramatical.',
    section: 'Botones',
  ...
  pt: {
    ...
    intro1:
      'Este é um exercício avançado, destinado àqueles que já dominaram os exercícios 5 e 6. É semelhante ao exercício 5, mas agora, em cada rodada, serão usados verbos aleatórios de todo o banco de dados.',
    intro2:
      'Em cada rodada, serão exibidos 6 pares de formas verbais. Sua tarefa é combinar corretamente as formas em hebraico com suas traduções no idioma selecionado. Assim como no exercício 5, você primeiro seleciona uma opção na coluna esquerda e depois a correspondente na coluna direita.',
    intro3:
      'Este exercício é recomendado para alunos avançados que já conhecem bem a conjugação de verbos em hebraico. Ele ajuda a desenvolver automatismo, aumentar a velocidade de reconhecimento e aprofundar a compreensão dos padrões de conjugação nos diferentes binyanim. A prática regular fortalece o domínio da conjugação, aumenta a confiança e melhora muito a intuição gramatical.',
    section: 'Botões',
    sound: 'Botões de som',
  ...
  ar: {
    ...
    intro1:
      'هذا تمرين متقدم مخصص لأولئك الذين أتموا التمارين 5 و6 بنجاح. وهو مشابه للتمرين 5، ولكن بدلاً من تصريف فعل واحد في الجولة، يتم اختيار عدة أفعال عشوائيًا من قاعدة البيانات.',
    intro2:
      'في كل جولة، ستُعرض 6 أزواج من صيغ الأفعال. مهمتك هي مطابقة الصيغ العبرية مع ترجماتها باللغة المختارة. كما في التمرين 5، تختار أولاً من العمود الأيسر ثم المطابقة من العمود الأيمن.',
    intro3:
      'هذا التمرين مخصص للمتعلمين المتقدمين الذين لديهم معرفة جيدة بتصريف الأفعال في العبرية. يساعد على تطوير التلقائية، وتحسين سرعة الفهم، وتعميق معرفة أنماط التصريف عبر البنيانيم المختلفة. الممارسة المنتظمة تساهم في ترسيخ النظام، وزيادة الثقة، وتحسين الحدس النحوي.',
    section: 'الأزرار',
  ...
  am: {
    ...
    intro1:
      'ይህ የላቀ ልምድ ሲሆን ልምዶች 5 እና 6 እንደሚሰሩ የተረዱ ተማሪዎች ለሚመሩ ነው። ከልምድ 5 ጋር ተመሳሳይ ነው፣ ግን በአንድ ዙር ላይ አንድ ግስ ሳይሆን ከመረጠ የግሶች መረጃ ቋት የተወሰኑ ግሶች ይታያሉ።',
    intro2:
      'በእያንዳንዱ ዙር 6 የተጣጣመ የግስ ቅርጾች ይታያሉ። እባኮትን ቅርጾቹን በዕብራይስጥ ከተሰጡት ትርጉሞች ጋር እንደተሟሉ ይዛመዱ። ከልምድ 5 ጋር ተመሳሳይ ሆኖ፣ መጀመሪያ ከግራ ተለዋዋጭ ተመርጧል ከዚያ ከቀኝ መስተዋት ነው።',
    intro3:
      'ይህ ልምድ በዕብራይስጥ ግሶች ሰዋሰው ዝቅተኛ የማይሆን እውቀት ላላቸው ተማሪዎች ይመረጣል። እንደ ልምድ እንዲቆይ እና በቀጣይነት ይሰራ ብለን እንደ ሕይወት መረዳት፣ ማሳወቂያ እና የሥነ-ሰዋሰው ሕሳብ እንዲጠናከር ያደርገዋል።',
    section: 'አዝራሮች',
...
const TaskDescriptionModal7 = ({ visible, onToggle, language }) => {
  // ✅ iOS: если закрыто — не монтируем
  ...
  return (
    ...
    >
      <View style={styles.backdrop}>
        {/* ✅ фон кликабельный, но не перехватывает жесты ScrollView */}
        ...
        <FadeInView style={styles.modalView}>
          ...
          >
            ...
            <View style={styles.screenshotWrapper}>
              {/* ⚠️ поставь правильный файл, если у тебя другой: scr7.jpg / scr5.jpg и т.д. */}
