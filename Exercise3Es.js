...
FirebaseAnalytics.logFirebaseEvent('exercise3es',{
screen:'exercise3es'
});
...
useEffect(() => {
  ...
  const handleExerciseCompletion = async () => {
    if (!statisticsUpdated) {
      ...
      setTimeout(async () => {
        try {
          await updateStatistics('exercise3Es', currentScore);
