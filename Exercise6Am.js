...
useEffect(() => {
 ...
 useEffect(() => {
  ...
  // ✅ init random verb: add formIndex
  useEffect(() => {
  ...
  // ✅ displayPairs: shuffle hebrew WITH formIndex, pass as hebrewFormIndex
  useEffect(() => {
    const start = page * 6;
    const end = start + 6;
...
const isNifalForCurrentVerb = useMemo(() => {
  ...
  /* ===================== ПОДСВЕТКА (как в русской/английской версии) ===================== */
