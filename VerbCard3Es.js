...
// ✅ super-safe: HITPA'EL / HITPAEL / hitpa-el -> "hitpael"
...
const VerbCard3Es = ({ verbData, onAnswer, soundEnabled, highlightEnabled = true }) => {
  ...
  return (
    <View style={styles.cardContainer}>
      <View style={styles.hebrewVerbContainer}>
        ...
        {/* ✅ корень: зелёная метка + чёрное значение (с подсветкой как EN/RU) */}
