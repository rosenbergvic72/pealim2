...
import VerbCard5 from './VerbCard5Es';
...
import TaskDescriptionModal5 from './TaskDescriptionModal5Es';
import StatModal5Es from './StatModal5Es';
...
const handleSpeakerPress = (mp3) => {
  ...
  const handleExerciseCompletion = async () => {
    if (!statisticsUpdated) {
      ...
      setTimeout(async () => {
        try {
          await updateStatistics('exercise5Es', currentScore);
