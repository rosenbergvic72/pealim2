...
import StatModal4Fr from './StatModal4Fr';
...
FirebaseAnalytics.logFirebaseEvent('exercise7fr',{
screen:'exercise7fr'
});
        ...
        <View style={styles.verbContainerWrapper}>
          {!isButtonActive ? (
            <View style={[styles.verbContainer, styles.inactiveButton]}>
              <Text style={styles.verbTextInactive} maxFontSizeMultiplier={1.2}>MONTRER L'INFINITIF</Text>
            </View>
          ) : (
            !showVerb ? (
              <TouchableOpacity
              ...
              >
                <Text style={styles.verbTextActive} maxFontSizeMultiplier={1.2}>MONTRER L'INFINITIF</Text>
              </TouchableOpacity>
            ) : (
              <Animated.View style={[styles.verbContainer, { opacity: fadeAnim }]}>
                ...
                <Text style={styles.verbTextRu} maxFontSizeMultiplier={1.2}> {selectedPair.french}</Text>
