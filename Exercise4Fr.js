...
import TaskDescriptionModal4Fr from './TaskDescriptionModal4Fr';
      ...
      <View style={styles.verbContainerWrapper}>
        {!isButtonActive ? (
          <View style={[styles.verbContainer, styles.inactiveButton]}>
            <Text style={styles.verbTextInactive}maxFontSizeMultiplier={1.2}>MONTRER L'INFINITIVE</Text>
          </View>
        ) : (
          !showVerb ? (
