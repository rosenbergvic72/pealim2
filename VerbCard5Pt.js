...
const VerbCard5Pt = ({ verbData, onAnswer }) => {
...
<View style={styles.lowerContainer}>
    ...
    <View style={styles.upperContainer}>
      <View style={styles.leftContainer}>
        <TypewriterTextLTR text={verbData.ImperPt} typingSpeed={40} style={styles.impertext}maxFontSizeMultiplier={1.2}/>
