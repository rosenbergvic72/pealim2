    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <Text style={styles.modalText}maxFontSizeMultiplier={1.2}>البحث حسب التمرين</Text>
          <TextInput
            style={styles.input}
            placeholder="العنصر النائب: أدخل كلمة للبحث"
          ...
          >
            <Text style={styles.buttonText}maxFontSizeMultiplier={1.2}>يبحث</Text>
          </TouchableOpacity>
          <ScrollView>
            {searchResults.length > 0 && (
              <Text style={styles.hintText}maxFontSizeMultiplier={1.2}>انقر للتصريف</Text>
            )}
          ...
          <TouchableOpacity
            ...
            onPress={onToggle}
          >
            <Text style={styles.closeButtonText}maxFontSizeMultiplier={1.2}>إغلاق</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
