...
const VerbCard5Ar = ({ verbData, onAnswer }) => {
...
<View style={styles.lowerContainer}>
    ...
    <View style={styles.upperContainer}>
      <View style={styles.leftContainer}>
        <TypewriterTextLTR text={verbData.ImperAr} typingSpeed={40} style={styles.impertext}maxFontSizeMultiplier={1.2}/>
