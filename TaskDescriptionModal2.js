...
const translations = {
  ru: {
    ...
    intro1: 'В этом упражнении вы сможете запомнить и повторить более 400 самых употребляемых глаголов иврита.',
    intro2:
  ...
  en: {
    ...
    intro1: 'In this exercise, you will be able to memorize and review about 400 of the most common Hebrew verbs.',
    intro2:
  ...
  fr: {
    ...
    intro1:
      'Dans cet exercice, vous pourrez mémoriser et réviser environ 400 des verbes hébreux les plus courants.',
    intro2:
  ...
  es: {
    ...
    intro1: 'En este ejercicio podrás memorizar y repasar unos 400 de los verbos hebreos más comunes.',
    intro2:
  ...
  pt: {
    ...
    intro1: 'Neste exercício, você poderá memorizar e revisar cerca de 400 dos verbos hebraicos mais comuns.',
    intro2:
  ...
  ar: {
    ...
    intro1: 'في هذا التمرين، يمكنك حفظ ومراجعة حوالي 400 من أكثر الأفعال العبرية شيوعًا.',
    intro2:
  ...
  am: {
    ...
    intro1: 'በዚህ ልምድ ውስጥ ከተለመዱት የዕብራይስጥ ግሶች 400 የሚጠጋገቡና የሚታወቁን መማረድና መድገም ይችላሉ።',
    intro2:
