  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.messageContainer}>
        <Text style={styles.completedMessage} maxFontSizeMultiplier={1.2}>¡Ejercicio completado!</Text>
        ...
        <TouchableOpacity onPress={restartTask}>
          <Text style={styles.continueButton} maxFontSizeMultiplier={1.2}>CONTINUAR</Text>
        </TouchableOpacity>
    
        <TouchableOpacity onPress={() => {
          handleOK();
          navigation.navigate('MenuEs'); // Направляем на экран MenuEn
        }}>
          <Text style={styles.completeButton} maxFontSizeMultiplier={1.2}>MENÚ</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default CompletionMessageEs;
