...
const translations = {
  ru: {
    ...
    intro2:
      'Вам будет показан инфинитив глагола на иврите, а также четыре варианта биньяна. Ваша задача — выбрать правильный биньян, к которому принадлежит глагол.',
    intro3:
      'Это упражнение подходит для тех, кто уже изучает иврит и имеет базовые знания о биньянах. Оно поможет лучше понимать структуру глаголов, быстрее узнавать их принадлежность к определённому биньяну и развить навык правильного употребления глаголов в речи.',
    section: 'Кнопки',
  ...
  en: {
    ...
    intro2:
      'You will be shown the infinitive of a Hebrew verb and four binyan options. Your task is to choose the correct binyan to which the verb belongs.',
    intro3:
      'This exercise is suitable for learners who already have basic knowledge of Hebrew binyanim. It will help you better understand verb structures, quickly recognize their binyan, and improve your ability to use verbs correctly in speech.',
    section: 'Buttons',
  ...
  fr: {
    ...
    intro2:
      'L’infinitif d’un verbe hébreu vous sera présenté avec quatre options de binyan. Votre tâche est de choisir le bon binyan auquel appartient le verbe.',
    intro3:
      'Cet exercice est destiné à ceux qui ont déjà des connaissances de base sur les binyanim en hébreu. Il vous aidera à mieux comprendre la structure des verbes, à reconnaître rapidement leur binyan et à améliorer votre usage correct des verbes.',
    section: 'Boutons',
  ...
  es: {
    ...
    intro2:
      'Verás el infinitivo del verbo en hebreo junto con cuatro opciones de binyan. Tu tarea es elegir el binyan correcto al que pertenece el verbo.',
    intro3:
      'Este ejercicio es ideal para quienes ya tienen conocimientos básicos sobre los binyanim. Te ayudará a comprender mejor la estructura de los verbos, reconocer más rápido su binyan y mejorar el uso correcto de los verbos en el habla.',
    section: 'Botones',
  ...
  pt: {
    ...
    intro2:
      'Será apresentado o infinitivo de um verbo em hebraico e quatro opções de binyan. Sua tarefa é escolher o binyan correto ao qual o verbo pertence.',
    intro3:
      'Este exercício é indicado para quem já possui conhecimentos básicos sobre os binyanim. Ele ajudará a compreender melhor a estrutura dos verbos, reconhecer rapidamente o binyan e melhorar o uso correto dos verbos na fala.',
    section: 'Botões',
    sound: 'Botões de som',
  ...
  ar: {
    ...
    intro2:
      'سيتم عرض الفعل بصيغة المصدر باللغة العبرية مع أربع خيارات للبنيان. مهمتك هي اختيار البنيان الصحيح الذي ينتمي إليه الفعل.',
    intro3:
      'هذا التمرين مخصص لمن لديهم معرفة أساسية بالبنيانيم. سيساعدك على فهم بنية الأفعال بشكل أفضل، والتعرف بسرعة على نوع البنيان، وتحسين استخدامك الصحيح للأفعال في الكلام.',
    section: 'الأزرار',
  ...
  am: {
    ...
    intro2:
      'የግሱ ነፃ ቅርጽ በዕብራይስጥ ይታያል፣ ከዚህ ጋር አራት የቢንያን አማራጮች ይሆናሉ። ትክክለኛውን ምርጫ ይምረጡ።',
    intro3:
      'ይህ ልምድ ቢንያንን በመጀመሪያ የተማሩ ሰዎች ይመረጣል። የግሶችን መዋቅር ማረዳትን፣ ቢንያን በፍጥነት መለየትን፣ ቃላትንም በትክክል መጠቀምን ይረዳዎታል።',
    section: 'አዝራሮች',
...
const TaskDescriptionModal3 = ({ visible, onToggle, language }) => {
...
export default TaskDescriptionModal3;
