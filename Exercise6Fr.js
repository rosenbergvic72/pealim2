...
FirebaseAnalytics.logFirebaseEvent('exercise5pt',{
screen:'exercise5pt'
});
...
exercise6LoggedRef.current=false;
 ...
 const finishExerciseWithDelay = useCallback((finalScore) => {
  ...
  setTimeout(async () => {
    ...
    await updateStatistics('exercise6Fr', Number(finalScore));
  }, 1400);
}, []);
          ...
          <View style={styles.container}>
            ...
            <Animated.View style={[styles.progressContainer, { opacity: fadeAnim }]}>
              <View style={styles.textContainer}>
                <Text style={styles.prtext} maxFontSizeMultiplier={1.2}>JUSTE: {correctCount}</Text>
