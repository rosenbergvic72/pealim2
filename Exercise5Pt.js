...
import VerbCard5 from './VerbCard5Pt';
...
import StatModal5Pt from './StatModal5Pt';
...
const handleSpeakerPress = (mp3) => {
  ...
  const handleExerciseCompletion = async () => {
    if (!statisticsUpdated) {
      ...
      setTimeout(async () => {
        try {
          await updateStatistics('exercise5Pt', currentScore);
