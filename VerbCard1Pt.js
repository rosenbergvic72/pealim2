...
const VerbCard1Pt = ({ verbData, onAnswer, soundEnabled }) => {
  ...
  return (
    <Animated.View style={[styles.cardContainer, shadowEnabled && styles.cardShadow]}>
      <View style={styles.hebrewVerbContainer}>
        ...
        <Animated.Text style={[styles.root, { opacity: opacity3 }]} maxFontSizeMultiplier={1.2}>{`Raiz: ${verbData.root}`}</Animated.Text>
