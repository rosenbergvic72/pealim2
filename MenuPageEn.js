...
export default function MenuPage({ route }) {
  ...
  const button9Opacity = useRef(new Animated.Value(0)).current;
    ...
    const fetchStatistics = async () => {
      const exerciseIds = ['exercise1En', 'exercise2En', 'exercise3En', 'exercise5En', 'exercise6En', 'exercise8En', 'exercise4En', 'exercise7En'];
      const statsData = {};
...
<View style={styles.statsRow}>
  <Text style={styles.statsText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE</Text>
  <View style={styles.statsBox}>
    <Text style={styles.statsValue} maxFontSizeMultiplier={1.2}>{averageCompletionRate}%</Text>
  </View>
</View>
<View style={styles.statsRow}>
  <Text style={styles.statsText} maxFontSizeMultiplier={1.2}>DAYS OF PRACTICE</Text>
          <View style={styles.statsBox}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity onPress={() => handlePress('Exercise1En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 1</Text>
                <Image source={require('./star1.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>VERB CARDS HEBREW - ENGLISH</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise1En'] ? stats['exercise1En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise1En'] ? stats['exercise1En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, { opacity: button2Opacity, transform: [{ translateY: button2TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise2En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 2</Text>
                <Image source={require('./star2.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>VERB CARDS ENGLISH - HEBREW</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise2En'] ? stats['exercise2En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise2En'] ? stats['exercise2En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, { opacity: button3Opacity, transform: [{ translateY: button3TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise3En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 3</Text>
                <Image source={require('./star3.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>DETERMINE THE VERB BINYAN</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise3En'] ? stats['exercise3En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise3En'] ? stats['exercise3En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, { opacity: button6Opacity, transform: [{ translateY: button6TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise5En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 4</Text>
                <Image source={require('./star3.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>IMPERATIVE MOOD</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise5En'] ? stats['exercise5En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise5En'] ? stats['exercise5En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, highlightedButtonStyle, { opacity: button6Opacity, transform: [{ translateY: button6TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise6En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 5</Text>
                <Image source={require('./star4.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>CONJUGATION ENGLISH - HEBREW</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise6En'] ? stats['exercise6En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise6En'] ? stats['exercise6En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, highlightedButtonStyle, { opacity: button6Opacity, transform: [{ translateY: button6TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise8En')}>
            <View style={styles.upperPart1}>
                <Text style={styles.upperText1} maxFontSizeMultiplier={1.2}>EXERCISE 6</Text>
                <Image source={require('./star4.png')} style={[styles.image1]} />
            </View>
            <View style={styles.upperPart2}>
                <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>CONJUGATION HEBREW - ENGLISH</Text>
            </View>
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise8En'] ? stats['exercise8En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise8En'] ? stats['exercise8En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, hardlightedButtonStyle, { opacity: button4Opacity, transform: [{ translateY: button4TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise4En')}>
            ...
            <View style={styles.lowerRight}>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>COMPLETED <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise4En'] ? stats['exercise4En'].timesCompleted : 0}</Text></Text>
                <Text style={styles.lowerText} maxFontSizeMultiplier={1.2}>AVERAGE SCORE <Text style={styles.statValue} maxFontSizeMultiplier={1.2}>{stats['exercise4En'] ? stats['exercise4En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
        </TouchableOpacity>
    </Animated.View>
    ...
    <Animated.View style={[styles.buttonContainer, hardlightedButtonStyle, { opacity: button7Opacity, transform: [{ translateY: button7TranslateY }] }]}>
        <TouchableOpacity onPress={() => handlePress('Exercise7En')}>
            ...
            <View style={styles.lowerRight}>
                          <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLETED  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7En'] ? stats['exercise7En'].timesCompleted : 0}</Text> </Text>
                          <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>AVERAGE SCORE  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7En'] ? stats['exercise7En'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
                        </View>
        </TouchableOpacity>
    </Animated.View>
  ...
  <Text style={styles.titleText1} maxFontSizeMultiplier={1.2}>APPLICATION DESCRIPTION</Text>
</TouchableOpacity>
</Animated.View>
