...
export default function MenuPage({ route }) {
  ...
  const fetchStatistics = async () => {
    const exerciseIds = ['exercise1En', 'exercise2En', 'exercise3En', 'exercise5En', 'exercise6', 'exercise8', 'exercise4', 'exercise7'];
    const stats = {};
      ...
      <View style={styles.content}>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button1Opacity, transform: [{ translateY: button1TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise1En')}>
            ...
            <Text style={styles.upperText} maxFontSizeMultiplier={1.2}>HEBREW-TO-ENGLISH VERB CARDS</Text>
            </View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button2Opacity, transform: [{ translateY: button2TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise2En')}>
            ...
            <View style={styles.upperPart2}>
              <Text style={styles.upperText}maxFontSizeMultiplier={1.2}>ENGLISH-TO-HEBREW VERB CARDS</Text>
            </View>
            <View style={styles.lowerRight}>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button3Opacity, transform: [{ translateY: button3TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise3En')}>
            ...
            <View style={styles.upperPart2}>
              <Text style={styles.upperText}maxFontSizeMultiplier={1.2}>IDENTIFY THE BINYAN</Text>
            </View>
            <View style={styles.lowerRight}>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button5Opacity, transform: [{ translateY: button5TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise6')}>
            ...
            <View style={styles.upperPart2}>
              <Text style={styles.upperText}maxFontSizeMultiplier={1.2}>VERB CONJUGATION ENGLISH-TO-HEBREW</Text>
            </View>
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLETED  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise6'] ? stats['exercise6'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>AVERAGE SCORE  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise6'] ? stats['exercise6'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button8Opacity, transform: [{ translateY: button8TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise8')}>
            ...
            <View style={styles.upperPart2}>
              <Text style={styles.upperText}maxFontSizeMultiplier={1.2}>VERB CONJUGATION HEBREW-TO-ENGLISH</Text>
            </View>
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLETED  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise8'] ? stats['exercise8'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>AVERAGE SCORE  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise8'] ? stats['exercise8'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button4Opacity, transform: [{ translateY: button4TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise4')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLETED  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise4'] ? stats['exercise4'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>AVERAGE SCORE  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise4'] ? stats['exercise4'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Animated.View style={[styles.buttonContainer, { opacity: button7Opacity, transform: [{ translateY: button7TranslateY }] }]}>
          <TouchableOpacity onPress={() => handlePress('Exercise7')}>
            ...
            <View style={styles.lowerRight}>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>COMPLETED  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7'] ? stats['exercise7'].timesCompleted : 0}</Text> </Text>
              <Text style={styles.lowerText}maxFontSizeMultiplier={1.2}>AVERAGE SCORE  <Text style={styles.statValue}maxFontSizeMultiplier={1.2}>{stats['exercise7'] ? stats['exercise7'].averageCompletionRate.toFixed(2) : 0}%</Text></Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
